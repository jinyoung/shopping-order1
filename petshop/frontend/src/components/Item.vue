<template>
    ...
    <v-card style="width:300px;" outlined>
        ...
        <v-card-text>
            ...
            <Money offline label="Price" v-model="value.price"
                    :editMode="editMode" @change="change"/>
            <OrderList offline label="Order" v-model="value.order"
                    :editMode="editMode" @change="change"/>
            <Pet offline label="Pet" v-model="value.pet"
...
<script>
    ...
    import OrderList from './listers/OrderChips.vue';
    ...
    export default {
        ...
        created(){
            ...
            if(typeof this.value === 'object') {
                ...
                if(!('order' in this.value)) {
                    this.value.order = null;
                }
                if(!('pet' in this.value)) {
                    this.value.pet = null;
                }
                if(!('pet' in this.value)) {
                    this.value.pet = null;
