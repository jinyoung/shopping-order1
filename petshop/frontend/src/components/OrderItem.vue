<template>
    ...
    <v-card style="width:300px;" outlined>
        ...
        <v-card-text>
            <div>
                <Number label="Item" v-model="value.item" :editMode="editMode"/>
            </div>
            <ItemList offline label="Item" v-model="value.item"
...
<script>
    ...
    import ItemList from './listers/ItemChips.vue';
    ...
    export default {
        ...
        created(){
            ...
            if(typeof this.value === 'object') {
                ...
                if(!('customer' in this.value)) {
                    this.value.customer = null;
                }
            }            
        },
